...
# entirely not working, think I'm confused about how to use podman to share container access to eachother with nix
# also tailscale serve just wont save its config
