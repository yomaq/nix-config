{ options, config, lib, pkgs, ... }:
{
  programs.ssh.knownHosts = {
    ...
    "azure".publicKey = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAILPJbDYeM58FlEhsWP861yNWG8gn51xbya7OT6q9gGZL";
    "azure-initrd".publicKey = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIOQ1sEoQpAUeNcggp1jUpbo0n+gYa6qioOM0vbmg7AVX";
