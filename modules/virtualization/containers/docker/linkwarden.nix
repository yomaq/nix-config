  ...
  config = lib.mkMerge [
    (lib.mkIf cfg.enable {
      ...
      virtualisation.oci-containers.containers = {
        ### DB container
        "DB${NAME}" = {
          image = "docker.io/postgres:16-alpine@sha256:3c5c8892d184f738f4fe282d14ddaa613a38f00f4189d2d94725ebe6f2909ddb";
          autoStart = true;
          # environment = {
        ...
        ### main container
        "${NAME}" = {
          image = "ghcr.io/linkwarden/linkwarden:latest@sha256:0664c28a039bda8ffa6663389e8536b2fc717219e329f85b83faca7efed3b144";
          autoStart = true;
          environment = {
