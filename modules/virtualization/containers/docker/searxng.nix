  ...
  config = lib.mkMerge [
    (lib.mkIf cfg.enable {
      ...
      virtualisation.oci-containers.containers = {
        ...
        "${NAME}" = {
          image = "docker.io/searxng/searxng:latest@sha256:a7f9188cc7fa8b6b037e0d85709c0dced8f05d0eba84145eb7fe7027a4c00850";
          autoStart = true;
