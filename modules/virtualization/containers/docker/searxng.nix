  ...
  config = lib.mkMerge [
    (lib.mkIf cfg.enable {
      ...
      virtualisation.oci-containers.containers = {
        "${NAME}-redis" = {
          image = "docker.io/valkey/valkey:8-alpine@sha256:918228e4ff7da6b3a4213cb18067f6e09d9f0503d0a08868699ba227cff71861";
          autoStart = true;
        ...
        "${NAME}" = {
          image = "docker.io/searxng/searxng:latest@sha256:670bd1076097640fc25221bf92a8af7d344503ce17ba3305abedf28e3634e807";
          autoStart = true;
