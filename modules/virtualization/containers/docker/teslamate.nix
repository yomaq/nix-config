  ...
  config = lib.mkMerge [
    (lib.mkIf cfg.enable {
      ...
      virtualisation.oci-containers.containers = {
        ### DB container
        "DB${NAME}" = {
          image = "docker.io/postgres:16@sha256:4b7183ac05f8ef417db21fd72d71047a4238340c261d3cc3ddb6d579ab5071ae";
          autoStart = true;
          environment = {
            # "PGUSER" = "teslamate";
          };
        ...
        ### Grafana container
        "grafana-${NAME}" = {
          image = "docker.io/teslamate/grafana:latest@sha256:8d7287f44b1eefb39e649175aa14615df648c04a3162da9461d07c8a9ea1c7e9";
          autoStart = true;
          environment = {
        ...
        ### main container
        "${NAME}" = {
          image = "docker.io/teslamate/teslamate:latest@sha256:b7b8b21869d789d043f62b404dd689f55c601ef7d02222e92c0f5d596d0b1044";
          autoStart = true;
          environment = {
            "DISABLE_MQTT" = "true";
